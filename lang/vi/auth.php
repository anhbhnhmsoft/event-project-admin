...
return [
    ...
    'error' => [
        ...
        'too_many_attempts_wait' => 'Quá nhiều lần thử, vui lòng thử lại sau :minutes phút',
        'email_already_registered' => 'Email đã được đăng ký',
        'invalid_username' => 'Tên người dùng không hợp lệ',
        'unverified_phone' => 'Số điện thoại chưa được xác thực',
        'invalid_request' => 'Yêu cầu không hợp lệ',
        'type_required' => 'Loại yêu cầu là bắt buộc',
        'type_in' => 'Loại yêu cầu không hợp lệ',
    ],
    'validation' => [
        ...
        'password_current' => 'Mật khẩu hiện tại không đúng',
        'password_min_reset' => 'Mật khẩu phải có ít nhất 8 ký tự',
        ...
        'organizer_required' => 'Nhà tổ chức là bắt buộc',
        'organizer_exists' => 'Nhà tổ chức không tồn tại',
        'organizer_integer' => 'Nhà tổ chức phải là số nguyên',
