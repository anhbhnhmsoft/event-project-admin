...
return [
    ...
    'common_error' => [
        ...
        'invalid_webhook_payload' => 'Dữ liệu webhook không hợp lệ.',
        'max_content' => 'Nội dung không được vượt quá :max ký tự.',
        'membership_not_found' => 'Không tìm thấy gói membership.',
        ...
        'transaction_already_processed' => 'Giao dịch đã được xử lý.',
