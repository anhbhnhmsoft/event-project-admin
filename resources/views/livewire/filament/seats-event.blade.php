                    ...
                    <form wire:submit="createArea" class="space-y-6">
                        <div class="flex justify-between items-start gap-4">
                            <div class="flex-1">
                                ...
                                <x-filament::input.wrapper>
                                    <x-filament::input type="number" class="dark:text-black text-white"
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" class="dark:text-black text-white"
                        ...
                        @if (!$event->free_to_join)
                            <div class="space-y-2">
                                ...
                                <x-filament::input.wrapper>
                                    <x-filament::input type="number" class="dark:text-black text-white" step="0.01"
                                                       min="0"
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between mb-4">
                        <button wire:click="updateArea"
                                class="px-4 py-2 bg-indigo-600 text-white rounded-lg">{{__('common.common_success.save')}}</button>
                            ...
                            <div x-show="hiddenDetailSeat" x-transition.scale
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="flex mt-1 space-x-2">
                                            <input type="text" wire:model.defer="newSeatName"
                                                   class="dark:text-black text-white flex-1 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"/>
                                ...
                                @else
                                    ...
                                    <input type="text" wire:model.live.debounce.300ms="userSearch"
                                           ...
                                           class="dark:text-black text-white w-full px-3 py-2 border rounded-lg mb-3 focus:ring-2 focus:ring-indigo-500">
