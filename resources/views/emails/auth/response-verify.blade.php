...
@section('content')
    @php
        ...
        $colors = [
            'success' => [
                ...
                'title' => __('emails.auth.verify_success_title'),
            ...
            'error' => [
                ...
                'title' => __('emails.auth.verify_failed_title'),
            ...
            'info' => [
                ...
                'title' => __('emails.auth.verify_info_title'),
    ...
    <div
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 px-4 py-8">
        <div
            class="w-full max-w-sm bg-white dark:bg-gray-800 shadow-xl rounded-3xl p-6 sm:p-8 text-center transition-all duration-300 hover:shadow-2xl">
            ...
            <div class="flex justify-center mb-6">
                <div class="relative">
                    <div
                        class="absolute inset-0 {{ $color['bg'] }} {{ $color['dark_bg'] }} rounded-full blur-xl opacity-50 animate-pulse">
                    </div>
                    <div
                        class="relative rounded-full {{ $color['bg'] }} {{ $color['dark_bg'] }} p-4 sm:p-5 border-2 {{ $color['border'] }} dark:border-opacity-50">
                        @if ($status === 'success')
