                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="mt-2 space-y-2">
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            ...
                                            <a href="{{ route('file_document', $file['file_path']) }}" target="_blank" class="flex items-center gap-2 p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-500 transition group/file">
                                                @php
